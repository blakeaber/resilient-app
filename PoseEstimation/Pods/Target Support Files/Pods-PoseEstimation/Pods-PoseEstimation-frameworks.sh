...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LDHTTPService/LDHTTPService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LDMainFramework/LDMainFramework.framework"
